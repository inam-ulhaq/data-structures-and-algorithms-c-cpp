...
// Author: Inam Ul Haq
// Description:
//  Lest head is pointer pointing the first node of a Linked list
//	and a poiter of the same type i.e struct Node *ptr;
//  1) ptr=head
...
//  1) ptr= ptr->next -> This statment will be meve the same pointer 
// 		to the next node 
//  2) ptr= ptr->next->next